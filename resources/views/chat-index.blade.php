    ...
    <main class="container-fluid">
        <div class="row justify-content-center align-items-center">
                ...
                <div class="col-8 p-5 d-none text-center d-md-flex justify-content-center align-items-center flex-column">
                    ...
                    <h1 class="colored-text text-uppercase">WELCOME TO SPARK CHAT, {{ Auth::user()->first_name }}!</h1>
                    <p class="colored-text text-uppercase">Click on a name to get started.</p>
                </div>
        </div>
    </main>
</x-app-layout>
